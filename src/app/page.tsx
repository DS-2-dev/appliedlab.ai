  ...
  return (
    <>
      ...
      <main id="main" className="bg-white text-[#1a1a1a]">
        ...
        <section className="font-archivo flex min-h-svh flex-col gap-10 px-5 pt-24 pb-10 lg:px-15 lg:pb-12">
          <div className="flex min-h-[14rem] flex-1 items-center justify-center">
            ...
            <img src="/star.svg" alt="" className="max-h-[46svh] w-[min(80vw,56rem)] object-contain" />
          </div>
